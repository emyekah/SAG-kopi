...
?>
<h4><i class="fa fa-search-plus"></i> Detail Produk</h4>
<hr />
<br />
<?php
$key = $data->row();
...
<div class="row">
   ...
   <div class="col l4 m12 s12 offset-l1 detail">
      ...
      <form action="<?= site_url('cart/add/'.$key->link); ?>" method="post" class="detail-item">
         ...
         <button type="submit" name="submit" value="Submit" class="btn blue waves-effect waves-light" <?php if($key->stok < 1) { echo 'disabled'; } ?>><i class="fa fa-shopping-cart"></i> Tambah</button>
