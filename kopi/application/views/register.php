...
<div class="row">
   <div class="col m10 s12 offset-m1">
      <h4 style="color:#939393"><i class="fa fa-pencil-square-o"></i> Form Pendaftaran</h4>
      <hr />
      <br />
         ...
         <div class="col m10 s12">
            <div class="row">
               <div class="input-field col m6 s12">
                  ...
                  <p class="help-text"><i>* Minimal 3 huruf</i></p>
               </div>
               <div class="input-field col m6 s12">
            ...
            <div class="row">
               <div class="input-field col m8 s12">
                  ...
                  <p class="help-text"><i>* Minimal 5 huruf. Tdk boleh pakai spasi</i></p>
               </div>
            </div>
            ...
            <div class="row">
               <div class="input-field col m8 s12">
                  ...
                  <p class="help-text"><i>* Isi dengan G-mail aktif anda </i></p>
               </div>
            </div>
            ...
            <div class="row">
               <div class="input-field col m6 s12">
                  ...
                  <p class="help-text"><i>* Minimal 5 huruf</i></p>
               </div>
               <div class="input-field col m6 s12">
