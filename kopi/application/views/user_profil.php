...
<div class="row">
   <div class="col m10 s12 offset-m1">
      <h4 style="color:#939393"><i class="fa fa-user"></i> Profil Pelanggan</h4>
      <hr />
      <br />
         ...
         <div class="col m10 s12">
            ...
            <div class="row">
               <div class="input-field col m8 s12">
                  <input type="text" id="username" class="validate" name="user" value="<?= $user; ?>" readonly>
            ...
            <div class="row">
               <div class="input-field col m8 s12">
                  <input type="email" id="email" class="validate" name="email" value="<?= $email; ?>" readonly>
