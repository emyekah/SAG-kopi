...
<html lang="en">
   <head>
      <title>Lupa Password | Kopi Mukidi</title>
   ...
   <body>
      <div class="container">
         <center>
            <span class="header"><i class="fa fa-shopping-cart"></i> kopi Mukidi</span>
         </center>
         <div class="col-md-6 col-sm-12 col-md-offset-3">
            ...
            <form class="form" action="" method="post">
               ...
               <div class="panel panel-primary">
                  <div class="panel-heading"><h4>Lupa Password</h4></div>
                  <div class="panel-body">
                     ...
                     <div class="form-group" style="text-align:right">
                        ...
                        <a href="<?= base_url('login'); ?>" class="btn btn-default">Masuk..</a>
                     </div>
