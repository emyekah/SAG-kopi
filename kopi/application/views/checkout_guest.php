         ...
         <div class="col m10 s12">
            ...
            <div class="row">
               <div class="input-field col m6 s12">
                  <input type="text" id="first_name" class="validate" name="first_name" value="" required>
                  <label for="first_name">Nama Depan</label>
               </div>
               <div class="input-field col m6 s12">
                  <input type="text" id="last_name" class="validate" name="last_name" value="" required>
            ...
            <div class="row">
               <div class="input-field col m8 s12">
                  <input type="email" id="user_mail" name="user_mail" value="" class="validate" required>
