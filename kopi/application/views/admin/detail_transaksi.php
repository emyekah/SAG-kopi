            ...
            <table class="table table-striped">
               ...
               foreach ($data->result() as $key):
                  ...
                  <tr>
                     ...
                     <td><?=$key->nama_item?></td>
                     <td><?=$key->qty?></td>
                     <td style="text-align:left"><?=number_format($key->biaya, 0, ',','.')?></td>
                  </tr>
               <?php endforeach; ?>
               <tr>
                  <td colspan="3">Ongkir</td>
                  <td style="text-align:left"><?=number_format($ongkir, 0, ',','.')?></td>
               </tr>
               <tr>
                  <td colspan="3">Total</td>
                  <td style="text-align:left"><?=number_format($user->total, 0, ',','.')?></td>
               </tr>
            </table>
